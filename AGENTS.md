...
- **No hook may emit a severity field (e.g. `routing_signal_escalation`, `in_sync`) without a declared consumer in the same change. Connect or delete; never leave dangling.**
